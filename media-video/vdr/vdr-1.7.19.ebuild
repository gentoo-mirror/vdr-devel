...
EXT_PATCH_FLAGS="alternatechannel cutterlimit cuttime
	ddepgentry dvlvidprefer graphtft hardlinkcutter jumpplay
	lnbshare mainmenuhooks menuorg noepg pinplugin setup timerinfo
	ttxtsubs validinput yaepg wareagleicon lircsettings"
# droped --> channelprovide, rotor
...
src_prepare() {
	...
	if ! use vanilla; then
		...
		# hotfix for missing jumpplay patch part
		epatch "${FILESDIR}/${P}_jumpplay-hotfix.diff"
