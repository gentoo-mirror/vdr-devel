...
HG_REVISION="159875070cab"
HG_REVISION_DATE="20111011"
...
src_prepare() {
	epatch "${FILESDIR}/OSD_RAW_CMD_patch_1.diff"
	epatch "${FILESDIR}/v4l-dvb-saa716x-Makefilepatch.diff"
}

src_compile() {
	BUILD_PARAMS="SUBDIRS=${S}/linux/drivers/media/common/saa716x CONFIG_SAA716X_CORE=m CONFIG_DVB_SAA716X_FF=m CONFIG_DVB_SAA716X_BUDGET=m"
