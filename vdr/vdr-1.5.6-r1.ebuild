...
IUSE_EXTENSIONS="cmdsubmenu cutterlimit cutterqueue cuttime ddepgentry
	...
	jumpplay liemikuutio lnbshare mainmenuhooks noepg osdmaxitems pinplugin
	rotor settime setup sortrecords sourcecaps submenu
	subtitles timercmd timerinfo validinput yaepg
...
src_unpack() {
	...
	epatch "${FILESDIR}/${P}-utf8-fix.diff"
...
src_install() {
	...
	newdoc ${EXT_DIR}/README.vdr-${EXT_VDR_PV:-${PV}} README.extensions-patch || die "Could not install README.extensions-patch"
